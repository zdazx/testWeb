...
<c:forEach var="UcltSearch" items="${userclt}">
  	<tr>
  		<td align="center">${UcltSearch.cltid}</td>
		<td align="center">${UcltSearch.cltname}</td>
  		<td align="center">${UcltSearch.cltphone}</td>
		<td align="center">${UcltSearch.cltadd}</td>
		<td align="center">${UcltSearch.cltbuytime}</td>
        <td align="center"><a href="UpdateUsercltServlet?cltid=${UcltSearch.cltid}&cltname=${UcltSearch.cltname}&cltphone=${UcltSearch.cltphone}
