...
<c:forEach var="UarrSearch" items="${arrange}">
  	<tr>
  		<td align="center">${UarrSearch.aid}</td>
        <td align="center"><a href="FindArrGooServlet?agid=${UarrSearch.agid}" target="zhong" style="color:#FD0105">${UarrSearch.agid}</a></td>
		<td align="center"><a href="FindArrCltServlet?acltid=${UarrSearch.acltid}" target="zhong" style="color:#FD0105">${UarrSearch.acltid}</a></td>
  		<td align="center"><a href="FindArrRepServlet?arep=${UarrSearch.arep}" target="zhong" style="color:#FD0105">${UarrSearch.arep}</a></td>
  		<td align="center">${UarrSearch.aresp}</td>	
		<td align="center">${UarrSearch.atime}</td>
  	</tr>
  </c:forEach>
