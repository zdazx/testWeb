...
<c:forEach var="UrepSearch" items="${userrep}">
  	<tr>
  		<td align="center">${UrepSearch.rep}</td>
		<td align="center">${UrepSearch.repname}</td>
  		<td align="center">${UrepSearch.repphone}</td>
		<td align="center">${UrepSearch.repadd}</td>
		<td align="center">${UrepSearch.repid}</td>
  		<td align="center">${UrepSearch.reptime}</td>
		<td align="center">${UrepSearch.repstate}</td>
		<td align="center"><a href="UpdateUserrepServlet?rep=${UrepSearch.rep}&repname=${UrepSearch.repname}&repphone=${UrepSearch.repphone}
