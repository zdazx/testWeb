...
<body>
<form  action="FindUsertypeServlet" method="post" name="myform"><br />
...
<c:forEach var="UremSearch" items="${usertype}">
  	<tr>
  		<td align="center">${UremSearch.rem}</td>
		<td align="center">${UremSearch.remname}</td>
  		<td align="center">${UremSearch.remphone}</td>
		<td align="center">${UremSearch.remadd}</td>
		<td align="center">${UremSearch.remid}</td>
  		<td align="center">${UremSearch.remtime}</td>
